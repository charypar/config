...
function __jj_all_bookmarkes
  __jj_bookmarkes '!remote || !remote.starts_with("git")' $argv[1]
end

function __jj_local_bookmarkes
  __jj_bookmarkes '!remote' ''
end

function __jj_remote_bookmarkes
  __jj_bookmarkes 'remote && !remote.starts_with("git")' ''
end
...
function __jj_all_changes
  if string length --quiet -- $argv[1]
   ...
   __jj_changes $REV; __jj_all_bookmarkes $REV
end
...
# bookmarkes.
complete -f -c jj -n '__jj_seen_subcommand_from bookmark; and __jj_seen_subcommand_from delete forget rename set d f r s' -ka '(__jj_local_bookmarkes)'
complete -f -c jj -n '__jj_seen_subcommand_from bookmark; and __jj_seen_subcommand_from track t' -ka '(__jj_bookmarkes "remote && !tracked" "")'
complete -f -c jj -n '__jj_seen_subcommand_from bookmark; and __jj_seen_subcommand_from untrack' -ka '(__jj_bookmarkes "remote && tracked && !remote.starts_with(\"git\")" "")'
...
complete -f -c jj -n '__jj_seen_subcommand_from git; and __jj_seen_subcommand_from fetch push' -s b -l bookmark -rka '(__jj_local_bookmarkes)'
